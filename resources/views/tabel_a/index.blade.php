                            ...
                            @if (count($data) > 0)
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-success" data-target="#modalPopup" data-toggle="modal" onclick="showModal('{{ $item->kode_baru }}', 'a')">Edit</button>
                                            <form method="POST" action="{{ route('a.delete', ['id' => $item->kode_baru]) }}">
                                                @csrf
