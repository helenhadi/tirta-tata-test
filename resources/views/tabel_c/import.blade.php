<form method="POST" enctype="multipart/form-data" action="{{route('c.import')}}">
    @csrf
    <div class="modal-body">
        ...
        <div class="row my-2">
            ...
            <div class="col-sm-8">
                ...
                <label class="form-control-label text-danger">*Klik di <a href="{{ asset('TableCImport.xlsx') }}" class="text-info" target="_blank" download>sini</a> untuk melihat contoh file</label>
            </div>
        </div>
    </div>
