            ...
            <div class="card">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="col text-right">
                        <button class="btn btn-sm btn-primary" data-target="#modalPopup" data-toggle="modal" onclick="showModal(0, 'c')">Add New Data</button>
                        <button class="btn btn-sm btn-success" data-target="#modalPopup" data-toggle="modal" onclick="showModal(0, 'c-import')">Import Data</button>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownExport">
                                <div class="dropdown-item">
                                    <a href="{{ route('c.export.excel') }}" class="btn btn-sm btn-info">Excel</a>
                                </div>
                                <div class="dropdown-item">
                                    <a href="{{ route('c.export.pdf') }}" class="btn btn-sm btn-warning">PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
